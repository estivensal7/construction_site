...
import ExteriorSideNav from '../../Components/ExteriorSideNav/ExteriorSideNav';
import CollapseInfoPanel from '../../Components/CollapseInfoPanel/CollapseInfoPanel';

//creating component
export default class ConcreteHardscapes extends Component {
constructor(props) {
  super(props);
...
render() {
  return (
      <div style={{marginBottom: '20px'}}> ConcreteHardscapes Page.
